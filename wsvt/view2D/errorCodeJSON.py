...
errorCodeJSON = {
    ...
    errorCode.MBR_VEC_EMPTY     : "The model return nothing for this selector with this role. Please enter another query.", # MemberVectors is empty, main query word 
    ...
    errorCode.NOT_IN_EMBEDDING  : "Returned word in the distributional model is not in the word embedding.",
