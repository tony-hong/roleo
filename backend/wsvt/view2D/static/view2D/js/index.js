...
function end_presentation_mode() {
  ...
  // change the column classes back
  document.getElementById("canvas_column").className = "col-md-7 col-sm-6 col-xs-12 col-ld-6";
  document.getElementById("right_menu_column").className = "col-md-3 col-sm-3 col-xs-12 col-ld-3";
